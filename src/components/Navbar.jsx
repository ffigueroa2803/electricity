...
import { themeSetScreenSize, themeSetActiveMenu, themeHandleClick, themeSetIsClicked } from "../features/theme/themeSlice"
...
const Navbar = () => {
  ...
  const { screenSize, currentColor, activeMenu, isClicked } = useSelector((state) => state?.theme)
            ...
            <>
              ...
              >
                ...
                <p>
                  ...
                  <span className="text-gray-900 ml-1 text-14">{data?.email}</span>
                </p>
