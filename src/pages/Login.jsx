      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="mt-8">
          ...
          <div className="mt-8 flex flex-col gap-y-4">
            ...
            <button className="flex rounded-md py-3 border-2 border-gray-100 items-center justify-center gap-2 ctive:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
