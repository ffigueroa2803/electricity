...
export const { themeSetScreenSize, themeSetMode, themeSetColor, themeSetThemeSettings, themeSetActiveMenu, themeSetIsClicked, themeHandleClick } = themeSlice.actions
